...
class Example:
    ...
    def vectorize(self) -> dict:
        ...
        # tail_dom = concept_dict.deduce_tail_dom(self.tail_id, self.relation)
        tail_dom = concept_dict.get_ent_dom(self.tail_id)
...
def collate(batch_data: List[dict]) -> dict:
    ...
    tail_doms = np.array([ex['tail_dom'] for ex in batch_data])
    tail_doms = torch.LongTensor(tail_doms)
