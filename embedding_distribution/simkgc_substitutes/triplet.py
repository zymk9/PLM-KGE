...
class EntityDict:
    ...
    def __init__(self, entity_dict_dir: str, inductive_test_path: str = None):
        ...
        print(self.entity_exs)
        # ############# add outdataset entities ############
        # outdataset_path = "/content/drive/MyDrive/SimKGC/data/FB15k237/outdataset_ents.json"
        # self.entity_exs += [EntityExample(**obj) for obj in json.load(open(outdataset_path, 'r', encoding='utf-8'))]
