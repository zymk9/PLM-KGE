...
from triplet import TripletDict, EntityDict, LinkGraph, ConceptDict
...
def _init_concept_dict():
    global concept_dict
    if not concept_dict:
        concept_dict = ConceptDict(concept_dict_dir=args.concept_path)
